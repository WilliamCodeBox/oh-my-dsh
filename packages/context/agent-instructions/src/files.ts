 ...
 *
 * @module @williamcodebox/omd-agent-instructions/files
 */

import { createReadStream } from 'node:fs'
import { stat } from 'node:fs/promises'
import { dirname, isAbsolute, join, relative, resolve } from 'node:path'
import type { FileSystem, FsInfo, FsTarget, FsVersion } from '@williamcodebox/omd-fs'
import { assertNever } from '@williamcodebox/omd-llm'
import { dshHomeDisplay } from '@williamcodebox/omd-home-paths'
