/**
 * Package-owned invariant companion for `@williamcodebox/omd-agent-instructions`.
 * @module @williamcodebox/omd-agent-instructions/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-agent-instructions'
