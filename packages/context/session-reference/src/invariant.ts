/**
 * Package-owned invariant companion for `@williamcodebox/omd-session-reference`.
 * @module @williamcodebox/omd-session-reference/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-session-reference'
