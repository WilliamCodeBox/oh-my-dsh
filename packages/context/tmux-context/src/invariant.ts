/**
 * Package-owned invariant companion for `@williamcodebox/omd-tmux-context`.
 * @module @williamcodebox/omd-tmux-context/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-tmux-context'
