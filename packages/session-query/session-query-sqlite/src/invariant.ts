/**
 * Package-owned invariant companion for `@williamcodebox/omd-session-query-sqlite`.
 * @module @williamcodebox/omd-session-query-sqlite/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-session-query-sqlite'
