 ...
 *
 * @module @williamcodebox/omd-session-query
 */

import { Context, Service } from '@williamcodebox/cordis'
import { Session, snapshotSessionEvent, type SessionId } from '@williamcodebox/omd-session'
import { foldSessionTitle } from '@williamcodebox/omd-session-title'
import type { SessionTitleSnapshot } from '@williamcodebox/omd-session-title'
import type {
