/**
 * Package-owned invariant companion for `@williamcodebox/omd-session-query`.
 * @module @williamcodebox/omd-session-query/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-session-query'
