 ...
 * `@williamcodebox/omd-tool-web`. Requests carry no browser cookies or ambient credentials.
 *
 ...
 * @module @williamcodebox/omd-web-fetch-http/provider
 */

import { WebError } from '@williamcodebox/omd-web'
import type { WebFetchBody, WebFetchProvider, WebFetchRequest, WebFetchResult } from '@williamcodebox/omd-web'
