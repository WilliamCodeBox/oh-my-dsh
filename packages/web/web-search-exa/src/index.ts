/**
 * `@williamcodebox/omd-web-search-exa`: registers an Exa-backed `WebSearchProvider`
 ...
 * seam's provider registry, exactly as `@williamcodebox/omd-llm-deepseek`
 * registers an adapter into `ctx.llm`. The key is owned by `@williamcodebox/omd-web`.
 *
 * @module @williamcodebox/omd-web-search-exa
 */
