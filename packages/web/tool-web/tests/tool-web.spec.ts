...
import type { WebSearchProvider, WebSearchResult } from '@williamcodebox/omd-web'
...
} from '@williamcodebox/omd-tool-web'
...
async function mountTools(opts: {
  ...
  fetchProvider?: import('@williamcodebox/omd-web').WebFetchProvider
