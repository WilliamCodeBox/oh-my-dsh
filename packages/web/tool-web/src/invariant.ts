/**
 * Package-owned invariant companion for `@williamcodebox/omd-tool-web`.
 * @module @williamcodebox/omd-tool-web/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-tool-web'
