...
import type { GenericCallView, JsonValue, ToolResult, WebFetchResultView } from '@williamcodebox/omd-tools'
import type { WebFetchBody, WebFetchResult } from '@williamcodebox/omd-web'
 ...
 * `@williamcodebox/omd-tool-call-timeout-policy`, not a model argument.
 *
 ...
 *   `ToolDefinition.timeoutMs` for `@williamcodebox/omd-tool-call-timeout-policy` to enforce.
