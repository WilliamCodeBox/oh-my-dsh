...
import HttpServer from '@williamcodebox/omd-host-webserver'
import type { DirectoryPicker } from '@williamcodebox/omd-host-directory-picker'
import BrowseDirectoryPicker from '@williamcodebox/omd-host-directory-picker-browse'
import NativeDirectoryPicker from '@williamcodebox/omd-host-directory-picker-native'
...
const AUTO = '@williamcodebox/omd-host-directory-picker-auto'
const NATIVE = '@williamcodebox/omd-host-directory-picker-native'
const BROWSE = '@williamcodebox/omd-host-directory-picker-browse'
const NATIVE_SURFACE = '@williamcodebox/omd-client-ui-directory-picker-native'
const BROWSE_SURFACE = '@williamcodebox/omd-client-ui-directory-picker-browse'
...
async function loadComposition(
  ...
  await writeFile(configPath, [
    "- name: '@williamcodebox/omd-host-webserver'",
    '  config:',
    `    host: '${bindHost}'`,
    '    port: 0',
    `- name: '${AUTO}'`,
  ...
  const modules = new Map<string, unknown>([
    ['@williamcodebox/omd-host-webserver', HttpServer],
