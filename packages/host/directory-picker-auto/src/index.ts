 ...
 * @module @williamcodebox/omd-host-directory-picker-auto
 */
...
export const BACKEND_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@williamcodebox/omd-host-directory-picker-native',
  browse: '@williamcodebox/omd-host-directory-picker-browse',
}
...
export const SURFACE_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@williamcodebox/omd-client-ui-directory-picker-native',
  browse: '@williamcodebox/omd-client-ui-directory-picker-browse',
}
