...
import type { AttachmentIdType, ImageAttachmentLimits, ImageAttachmentRef, ImageMediaType } from '@williamcodebox/omd-attachment'
import type { ContentBlock } from '@williamcodebox/omd-llm/types'
import type { SessionEvent, SessionId } from '@williamcodebox/omd-session/types'
// The pure-type outlet: api/ is browser-importable, and the package root's
// cordis Context merge (via dsh-agent) must not enter client aggregates.
import type { SessionProjectionMap } from '@williamcodebox/omd-session-projection/types'
...
declare module '@williamcodebox/omd-llm' {
