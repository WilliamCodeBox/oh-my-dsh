/**
 * Package-owned invariant companion for `@williamcodebox/omd-host-apiproxy`.
 * @module @williamcodebox/omd-host-apiproxy/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-host-apiproxy'
