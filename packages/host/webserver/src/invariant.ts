/**
 * Package-owned invariant companion for `@williamcodebox/omd-host-webserver`.
 * @module @williamcodebox/omd-host-webserver/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-host-webserver'
