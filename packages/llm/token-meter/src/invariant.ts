/**
 * Package-owned invariant companion for `@williamcodebox/omd-token-meter`.
 * @module @williamcodebox/omd-token-meter/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-token-meter'
