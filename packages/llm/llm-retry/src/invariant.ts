/** Package-owned durable retry-event invariants. @module @williamcodebox/omd-llm-retry/invariant */

import type { Context } from '@williamcodebox/cordis'
import type { Session, SessionEvent } from '@williamcodebox/omd-session'
import type { LlmFailure } from '@williamcodebox/omd-llm'
...
const PACKAGE_NAME = '@williamcodebox/omd-llm-retry'
