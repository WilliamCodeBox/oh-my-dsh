/**
 * Package-owned invariant companion for `@williamcodebox/omd-settings`.
 * @module @williamcodebox/omd-settings/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-settings'
