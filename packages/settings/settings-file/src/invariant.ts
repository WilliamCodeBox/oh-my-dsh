/**
 * Package-owned invariant companion for `@williamcodebox/omd-settings-file`.
 * @module @williamcodebox/omd-settings-file/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-settings-file'
 ...
 * tests; the in-process commit relation is owned by `@williamcodebox/omd-settings`.
 */
