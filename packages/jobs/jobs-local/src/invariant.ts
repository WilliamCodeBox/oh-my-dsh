/**
 * Package-owned invariant companion for `@williamcodebox/omd-jobs-local`.
 * @module @williamcodebox/omd-jobs-local/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-jobs-local'
...
/**
 * No runtime invariant: `@williamcodebox/omd-jobs/invariant` owns per-snapshot identity, status,
