/**
 * Package-owned invariant companion for `@williamcodebox/omd-tool-jobs`.
 * @module @williamcodebox/omd-tool-jobs/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-tool-jobs'
