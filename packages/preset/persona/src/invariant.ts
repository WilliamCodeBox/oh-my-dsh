/**
 * Package-owned invariant companion for `@williamcodebox/omd-persona`.
 * @module @williamcodebox/omd-persona/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-persona'
