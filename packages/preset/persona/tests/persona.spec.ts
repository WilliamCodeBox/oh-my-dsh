...
import { createScope, type ScopeKey } from '@williamcodebox/omd-scope'
import { describe, expect, it } from 'vitest'
import * as Persona from '@williamcodebox/omd-persona'
import { PERSONA_SECTION } from '@williamcodebox/omd-persona'
