 ...
 * @module @williamcodebox/omd-agent-presets/mount
 */
...
import type { EntryTree } from '@williamcodebox/cordis-plugin-loader'
import { scopeOf, scopeParentOf, type ScopeKey } from '@williamcodebox/omd-scope'
...
class PresetTree extends Include {
   ...
   * dependencies, so every `@williamcodebox/omd-*` row would fail to import. The
