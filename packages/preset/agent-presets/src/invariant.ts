/**
 * Package-owned invariant companion for `@williamcodebox/omd-agent-presets`.
 * @module @williamcodebox/omd-agent-presets/invariant
 */
...
import { leakedServices, livePresetMounts } from '@williamcodebox/omd-agent-presets'

const PACKAGE_NAME = '@williamcodebox/omd-agent-presets'
