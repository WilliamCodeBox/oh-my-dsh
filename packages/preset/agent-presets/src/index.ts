 ...
 * @module @williamcodebox/omd-agent-presets
 */

import { stat } from 'node:fs/promises'
import { Context, Service } from '@williamcodebox/cordis'
import z from '@williamcodebox/schemastery'
import { bindScopeParent, createScope, scopeOf, type Scope, type ScopeKey, type ScopeParentBinding } from '@williamcodebox/omd-scope'
// Type-only: resolves the `agent/created` lifecycle event this service watches.
import type {} from '@williamcodebox/omd-agent'
import { settingsNamespace, type SettingsScope, type default as SettingsService } from '@williamcodebox/omd-settings'
