/** Package-owned invariant companion for the subprocess seam. @module @williamcodebox/omd-subprocess/invariant */

import type { Context } from '@williamcodebox/cordis'
import type { InvariantInstaller } from '@williamcodebox/omd-invariants'

const PACKAGE_NAME = '@williamcodebox/omd-subprocess'
