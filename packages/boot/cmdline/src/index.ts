/**
 * @williamcodebox/omd-cmdline — the command line a dsh launcher hands to the app
 * it boots.
 *
 ...
 * @module @williamcodebox/omd-cmdline
 */
 ...
 * verbatim and in argv order. `omd --profile tui --resume abc` yields
 * `['--resume', 'abc']`.
 */
