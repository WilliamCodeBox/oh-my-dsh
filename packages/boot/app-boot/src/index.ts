 ...
 * @module @williamcodebox/omd-app-boot
 */
...
import { Context, type FiberState } from '@williamcodebox/cordis'
import Loader, { type Entry, type EntryOptions } from '@williamcodebox/cordis-plugin-loader'
import Include, { applyEntryPatches, entryListSchema, type PatchOptions } from '@williamcodebox/cordis-plugin-include'
import Group from '@williamcodebox/cordis-plugin-group'
import { dshHomePath, resolveDshHome } from '@williamcodebox/omd-home-paths'
import { createLaunchEnvironmentSnapshot, type LaunchEnvironmentSnapshot } from '@williamcodebox/omd-launch-environment'
import type {} from '@williamcodebox/cordis-plugin-hmr'
 ...
 * entries (`@williamcodebox/cordis-plugin-include`'s `PatchOptions`): id-targeted config
 ...
 * `@williamcodebox/cordis-plugin-include` `PatchOptions` (id-targeted config overrides and
...
export async function mountRootInclude(
  ...
  // preset living outside this workspace cannot resolve `@williamcodebox/cordis-plugin-group`
