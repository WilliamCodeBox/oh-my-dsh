/**
 * Package-owned invariant companion for `@williamcodebox/omd-session-checkpoint-policy`.
 * @module @williamcodebox/omd-session-checkpoint-policy/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-session-checkpoint-policy'
