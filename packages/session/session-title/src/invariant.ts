/**
 * Package-owned invariant companion for `@williamcodebox/omd-session-title`.
 * @module @williamcodebox/omd-session-title/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-session-title'
