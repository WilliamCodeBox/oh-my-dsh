 ...
 * @module @williamcodebox/omd-session-title
 */

import { Context, FiberState, Service, type Fiber } from '@williamcodebox/cordis'
import z from '@williamcodebox/schemastery'
import { z as zod } from 'zod'
import type { Branded } from '@williamcodebox/omd-brand'
import { assertNever, deepFreeze, isAgentLoopRequest } from '@williamcodebox/omd-llm'
import type { GenerateOptions } from '@williamcodebox/omd-llm'
import type {
  Session,
  SessionEvent,
