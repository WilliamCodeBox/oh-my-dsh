 ...
 *
 * @module @williamcodebox/omd-session-telemetry-otel
 */

import { createRequire } from 'node:module'
import z from '@williamcodebox/schemastery'
import type { Context } from '@williamcodebox/cordis'
import type {} from '@williamcodebox/omd-command-feedback'
import {
...
} from '@williamcodebox/omd-session-telemetry'
import { APP_IDENTITY } from '@williamcodebox/omd-llm'
...
export class OpenTelemetrySessionBackend extends SessionTelemetryBackend {
  ...
  constructor(ctx: Context, config: Config) {
    ...
    const ledger = this.provider.getLogger('@williamcodebox/omd-session-telemetry-otel', version)
    const ops = this.provider.getLogger('@williamcodebox/omd-session-telemetry-otel/ops', version)
