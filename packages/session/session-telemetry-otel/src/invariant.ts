/**
 * Package-owned invariant companion for `@williamcodebox/omd-session-telemetry-otel`.
 * @module @williamcodebox/omd-session-telemetry-otel/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-session-telemetry-otel'
