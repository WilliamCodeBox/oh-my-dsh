/**
 * Package-owned invariant companion for `@williamcodebox/omd-session-projection`.
 * @module @williamcodebox/omd-session-projection/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-session-projection'
