 ...
 * @module @williamcodebox/omd-session-persistence
 */

import { Context, Service } from '@williamcodebox/cordis'
import { SessionPreparation } from '@williamcodebox/omd-session'
import type { SessionEvent, SessionId, SessionHeader } from '@williamcodebox/omd-session'
import type { SessionPersistenceRevision } from './revision.ts'

// Re-export the metadata vocabulary so Consumers import it from the Service Definition.
export type { SessionHeader } from '@williamcodebox/omd-session'
