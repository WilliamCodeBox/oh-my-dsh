/**
 * Package-owned invariant companion for `@williamcodebox/omd-session-persistence`.
 * @module @williamcodebox/omd-session-persistence/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-session-persistence'
