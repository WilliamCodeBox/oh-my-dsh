 ...
 * @module @williamcodebox/omd-session-title-llm
 */

import type { Context } from '@williamcodebox/cordis'
import z from '@williamcodebox/schemastery'
import { createUserMessage, BlockAssembler, deepFreeze } from '@williamcodebox/omd-llm'
import type { FinishReason, GenerateOptions, Message } from '@williamcodebox/omd-llm'
import { deadline, MAX_TIMER_DELAY_MS } from '@williamcodebox/omd-timeout'
import {
  normalizeSessionTitle,
  SessionTitleProviderId,
} from '@williamcodebox/omd-session-title'
import type {
