/**
 * Package-owned invariant companion for `@williamcodebox/omd-session-title-llm`.
 * @module @williamcodebox/omd-session-title-llm/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-session-title-llm'
