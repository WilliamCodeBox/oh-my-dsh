/**
 * Package-owned invariant companion for `@williamcodebox/omd-session-telemetry`.
 * @module @williamcodebox/omd-session-telemetry/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-session-telemetry'
