/**
 * Package-owned invariant companion for `@williamcodebox/omd-session-persistence-jsonl`.
 * @module @williamcodebox/omd-session-persistence-jsonl/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-session-persistence-jsonl'
