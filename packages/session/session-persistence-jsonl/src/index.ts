 ...
 * @module @williamcodebox/omd-session-persistence-jsonl
 */
...
import type { SessionEvent, SessionId, SessionHeader, SessionPreparation } from '@williamcodebox/omd-session'
import {
