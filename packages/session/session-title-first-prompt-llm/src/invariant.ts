/**
 * Package-owned invariant companion for `@williamcodebox/omd-session-title-first-prompt-llm`.
 * @module @williamcodebox/omd-session-title-first-prompt-llm/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-session-title-first-prompt-llm'
