 ...
 *
 * The seam itself lives in `@williamcodebox/omd-compaction`, which re-exports these
 ...
 *
 * @module @williamcodebox/omd-compaction/checkpoint
 */

import type { MessageSource } from '@williamcodebox/omd-llm/message'
