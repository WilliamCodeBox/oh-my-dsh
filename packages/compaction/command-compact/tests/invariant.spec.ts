...
import * as invariant from '@williamcodebox/omd-command-compact/invariant'
...
describe('command-compact invariant companion', () => {
  it('registers the package-owned no-op installer', async () => {
    ...
    expect(register).toHaveBeenCalledWith('@williamcodebox/omd-command-compact', expect.any(Function))
    expect(() => {
