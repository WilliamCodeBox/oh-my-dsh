...
import CommandRuntime, { type CommandResult } from '@williamcodebox/omd-commands'
import {
  CompactionId,
  CompactionEngine,
...
import * as commandCompact from '@williamcodebox/omd-command-compact'
...
describe('@williamcodebox/omd-command-compact registration', () => {
