/**
 * Package-owned invariant companion for `@williamcodebox/omd-command-compact`.
 * @module @williamcodebox/omd-command-compact/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-command-compact'
