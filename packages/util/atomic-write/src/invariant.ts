/**
 * Package-owned invariant companion for `@williamcodebox/omd-atomic-write`.
 * @module @williamcodebox/omd-atomic-write/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-atomic-write'
