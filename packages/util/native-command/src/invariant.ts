/**
 * Package-owned invariant companion for `@williamcodebox/omd-native-command`.
 * @module @williamcodebox/omd-native-command/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-native-command'
