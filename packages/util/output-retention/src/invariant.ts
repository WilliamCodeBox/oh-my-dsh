/**
 * Package-owned invariant companion for `@williamcodebox/omd-output-retention`.
 * @module @williamcodebox/omd-output-retention/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-output-retention'
