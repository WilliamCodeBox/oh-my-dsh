/**
 * Package-owned invariant companion for `@williamcodebox/omd-launch-environment`.
 * @module @williamcodebox/omd-launch-environment/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-launch-environment'
