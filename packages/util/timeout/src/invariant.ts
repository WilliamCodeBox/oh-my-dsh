/**
 * Package-owned invariant companion for `@williamcodebox/omd-timeout`.
 * @module @williamcodebox/omd-timeout/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-timeout'
