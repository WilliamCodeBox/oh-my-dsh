/**
 * Package-owned invariant companion for `@williamcodebox/omd-home-paths`.
 * @module @williamcodebox/omd-home-paths/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-home-paths'
