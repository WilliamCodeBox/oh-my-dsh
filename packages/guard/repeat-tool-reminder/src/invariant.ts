/**
 * Package-owned invariant companion for `@williamcodebox/omd-repeat-tool-reminder`.
 * @module @williamcodebox/omd-repeat-tool-reminder/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-repeat-tool-reminder'
