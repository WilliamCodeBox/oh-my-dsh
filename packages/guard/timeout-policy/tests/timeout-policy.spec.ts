/**
 * Unit + real-load-path coverage for @williamcodebox/omd-tool-call-timeout-policy. The
...
import { CallId, HarnessError } from '@williamcodebox/omd-llm'
import SystemPrompt from '@williamcodebox/omd-system-prompt'
import ToolRuntime, { defineContentToolFixture, TOOL_ABORTED, type ToolExecutionInput, type PostToolDecision } from '@williamcodebox/omd-tools'
import * as timeoutPolicy from '@williamcodebox/omd-tool-call-timeout-policy'
import { TOOL_TIMEOUT } from '@williamcodebox/omd-tool-call-timeout-policy'
