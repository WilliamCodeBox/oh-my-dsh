/**
 * Package-owned invariant companion for `@williamcodebox/omd-cordis-client-runner`.
 * @module @williamcodebox/omd-cordis-client-runner/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-cordis-client-runner'
