/**
 * Package-owned invariant companion for `@williamcodebox/omd-client-ui-cordis`.
 * @module @williamcodebox/omd-client-ui-cordis/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-client-ui-cordis'
