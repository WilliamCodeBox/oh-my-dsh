/**
 * Package-owned invariant companion for `@williamcodebox/omd-tool-cordis`.
 * @module @williamcodebox/omd-tool-cordis/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-tool-cordis'
