 ...
 * @module @williamcodebox/omd-cordis-host-runner/guard
 */

import { Context } from '@williamcodebox/cordis'
import type { Plugin } from '@williamcodebox/cordis'
import { scopeOf } from '@williamcodebox/omd-scope'
import { assertSupportedJsonSchema, defineTool } from '@williamcodebox/omd-tools'
...
function sandboxContext(ctx: Context, reportFailure: (error: Error) => void): Context {
  ...
  // (`@williamcodebox/omd-cordis-client-runner`, whose CTX_VERBS names this one its
