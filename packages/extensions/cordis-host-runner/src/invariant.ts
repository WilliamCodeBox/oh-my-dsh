/**
 * Package-owned invariant companion for `@williamcodebox/omd-cordis-host-runner`.
 * @module @williamcodebox/omd-cordis-host-runner/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-cordis-host-runner'
