 ...
 * one result.
 *
 * @module @williamcodebox/omd-subagent-in-process-driver
 */

import { randomUUID } from 'node:crypto'
import type { Context } from '@williamcodebox/cordis'
import { foldConsumedWork } from '@williamcodebox/omd-agent'
...
import { createUserMessage, type ContentBlock } from '@williamcodebox/omd-llm'
import {
