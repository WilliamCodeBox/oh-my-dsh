/**
 * Package-owned invariant companion for `@williamcodebox/omd-tool-subagent-control`.
 * @module @williamcodebox/omd-tool-subagent-control/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-tool-subagent-control'
