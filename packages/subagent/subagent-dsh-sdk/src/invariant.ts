/**
 * Package-owned invariant companion for `@williamcodebox/omd-subagent-dsh-sdk`.
 * @module @williamcodebox/omd-subagent-dsh-sdk/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-subagent-dsh-sdk'
