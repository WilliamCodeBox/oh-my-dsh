/**
 * Package-owned invariant companion for `@williamcodebox/omd-subagent-codex`.
 * @module @williamcodebox/omd-subagent-codex/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-subagent-codex'
