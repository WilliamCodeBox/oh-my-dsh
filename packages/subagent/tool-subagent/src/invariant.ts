/**
 * Package-owned invariant companion for `@williamcodebox/omd-tool-subagent`.
 * @module @williamcodebox/omd-tool-subagent/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-tool-subagent'
