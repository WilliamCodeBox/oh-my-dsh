 ...
 *
 * @module @williamcodebox/omd-subagent/types
 */

import type { Agent, AgentOptions } from '@williamcodebox/omd-agent'
...
import type { ObjectJsonSchema, ToolRestriction } from '@williamcodebox/omd-tools'
