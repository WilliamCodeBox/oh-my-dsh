 ...
 * (`@williamcodebox/omd-subagent-spawn-in-process`, `-fork`, `-acp`) and the model-facing
 * consumer (`@williamcodebox/omd-tool-subagent`) are separate packages.
 *
...
import { assertObjectJsonSchema } from '@williamcodebox/omd-tools'
import type { ContentBlock, MessageId } from '@williamcodebox/omd-llm'
