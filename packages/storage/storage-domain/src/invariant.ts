/**
 * Package-owned invariant companion for `@williamcodebox/omd-storage-domain`: every
 ...
 * @module @williamcodebox/omd-storage-domain/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-storage-domain'
