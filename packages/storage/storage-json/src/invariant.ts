/**
 * Package-owned invariant companion for `@williamcodebox/omd-storage-json`.
 * @module @williamcodebox/omd-storage-json/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-storage-json'
