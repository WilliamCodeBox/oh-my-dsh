/**
 * Package-owned invariant companion for `@williamcodebox/omd-storage-sqlite`.
 * @module @williamcodebox/omd-storage-sqlite/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-storage-sqlite'
