/**
 * Package-owned invariant companion for `@williamcodebox/omd-storage`.
 * @module @williamcodebox/omd-storage/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-storage'
