/** Package-owned goal-round prompt invariants. @module @williamcodebox/omd-goal-round-driver/invariant */

import { isDeepStrictEqual } from 'node:util'
import type { Context } from '@williamcodebox/cordis'
import { foldGoal, type FoldedGoal, type GoalMessageSource, type GoalView } from '@williamcodebox/omd-goal'
...
const PACKAGE_NAME = '@williamcodebox/omd-goal-round-driver'
