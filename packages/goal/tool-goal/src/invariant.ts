/**
 * Package-owned invariant companion for `@williamcodebox/omd-tool-goal`.
 * @module @williamcodebox/omd-tool-goal/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-tool-goal'
