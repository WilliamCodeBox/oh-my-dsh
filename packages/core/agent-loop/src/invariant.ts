 ...
 * @module @williamcodebox/omd-agent-loop/invariant
 */

import type { Context } from '@williamcodebox/cordis'
import { isAgentLoopRequest, type GenerateOptions } from '@williamcodebox/omd-llm'
import type { InvariantFailure, InvariantInstaller } from '@williamcodebox/omd-invariants'
import { foldRequestHeader } from '@williamcodebox/omd-session'

const PACKAGE_NAME = '@williamcodebox/omd-agent-loop'
