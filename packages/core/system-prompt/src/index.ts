 ...
 *
 * @module @williamcodebox/omd-system-prompt
 */

import { Context, Service } from '@williamcodebox/cordis'
import z from '@williamcodebox/schemastery'
import { AnonymousEntries, NamedEntries, ScopedLayers, scopeTarget } from '@williamcodebox/omd-scope'
import type { ScopeKey, ScopeLayer, Scoped } from '@williamcodebox/omd-scope'
import type { ContextSnapshotSection, ToolSchema } from '@williamcodebox/omd-llm'
...
declare module '@williamcodebox/cordis' {
  ...
  interface Events {
     ...
     * Scope-filtered dispatch (`@williamcodebox/omd-scope`): scoped listeners
