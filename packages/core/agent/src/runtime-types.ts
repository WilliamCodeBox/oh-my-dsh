 ...
 * turn/step boundaries remain `@williamcodebox/omd-session` events.
 *
...
import type { LlmCallConfig, LlmFailure, ResolvedRetryPolicy } from '@williamcodebox/omd-llm'
import type { AgentCancelCause, Session, SessionId, UserMessage } from '@williamcodebox/omd-session'
export type { AgentCancelCause } from '@williamcodebox/omd-session'
import type { Inbox } from './inbox.ts'
import type { InboxTarget } from './types.ts'
import type {} from '@williamcodebox/omd-system-prompt'
declare module '@williamcodebox/omd-system-prompt' {
...
declare module '@williamcodebox/cordis' {
  interface Events {
     ...
     * Scope-filtered dispatch (`@williamcodebox/omd-scope`): agent-scoped listeners receive only that agent.
     * @mode emit
     */
