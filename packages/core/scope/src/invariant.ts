/** Package-owned scoped-dispatch invariants. @module @williamcodebox/omd-scope/invariant */

import type { Context } from '@williamcodebox/cordis'
import type { InvariantInstaller } from '@williamcodebox/omd-invariants'
import { carrierKeyOf, isScopeCarrier } from '@williamcodebox/omd-scope'
import { scopedSubjectResolverFor } from './scoped-events.generated.ts'

const PACKAGE_NAME = '@williamcodebox/omd-scope'
