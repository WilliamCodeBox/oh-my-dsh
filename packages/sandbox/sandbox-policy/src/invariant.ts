/** Package-owned session-event invariants for sandbox policy. @module @williamcodebox/omd-sandbox-policy/invariant */
...
const PACKAGE_NAME = '@williamcodebox/omd-sandbox-policy'
