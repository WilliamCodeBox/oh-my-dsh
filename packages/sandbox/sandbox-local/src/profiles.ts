 ...
 *
 * @module @williamcodebox/omd-sandbox-local/profiles
 */

import { grantArgs as landlockGrantArgs } from '@williamcodebox/node-addon-landlock-run'
 ...
 * (`@williamcodebox/omd-fs-sandbox`) can never drift apart.
