...
const platformPackageName = `@williamcodebox/node-addon-landlock-run-linux-${process.arch}`
...
const WORKSPACE_CLOSURE = [
  ...
  // consumer resolves it like any other @williamcodebox peer (koffi arrives
  // from the registry).
