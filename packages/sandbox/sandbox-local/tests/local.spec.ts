...
import { LAUNCHER_FAILURE_EXIT } from '@williamcodebox/node-addon-landlock-run'
import { SANDBOX_UNAVAILABLE, SandboxUnavailableError } from '@williamcodebox/omd-sandbox'
import type { SandboxPolicy } from '@williamcodebox/omd-sandbox'
import {
  LocalSandboxProvider,
} from '@williamcodebox/omd-sandbox-local'
import type { Config } from '@williamcodebox/omd-sandbox-local'
...
describe('the platform chains', () => {
  ...
  // live in @williamcodebox/omd-sandbox-windows-acl/tests/provider-chain.spec.ts
