/**
 * Package-owned invariant companion for `@williamcodebox/omd-sandbox-windows-acl`.
 * @module @williamcodebox/omd-sandbox-windows-acl/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-sandbox-windows-acl'
