/**
 * Package-owned invariant companion for `@williamcodebox/omd-sdk-client`.
 * @module @williamcodebox/omd-sdk-client/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-sdk-client'
