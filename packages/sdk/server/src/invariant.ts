/**
 * Package-owned invariant companion for `@williamcodebox/omd-sdk-jsonrpc-server`.
 * @module @williamcodebox/omd-sdk-jsonrpc-server/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-sdk-jsonrpc-server'
