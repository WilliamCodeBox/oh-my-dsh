 ...
 * (`@williamcodebox/omd-sdk-jsonrpc-server`) serves this protocol; SDK clients
 * (`@williamcodebox/omd-sdk-client`, the Python SDK) drive it.
 *
 * @module @williamcodebox/omd-sdk-protocol
 */
