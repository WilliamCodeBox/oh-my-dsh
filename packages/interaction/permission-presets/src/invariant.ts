/** Package-owned permission-preset event invariants. @module @williamcodebox/omd-permission-presets/invariant */
...
const PACKAGE_NAME = '@williamcodebox/omd-permission-presets'
