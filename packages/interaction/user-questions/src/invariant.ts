/**
 * Package-owned invariant companion for `@williamcodebox/omd-user-questions`.
 * @module @williamcodebox/omd-user-questions/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-user-questions'
