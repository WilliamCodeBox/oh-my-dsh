/**
 * Package-owned invariant companion for `@williamcodebox/omd-tool-ask-user`.
 * @module @williamcodebox/omd-tool-ask-user/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-tool-ask-user'
