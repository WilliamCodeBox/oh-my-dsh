/**
 * Package-owned invariant companion for `@williamcodebox/omd-tool-str-replace-editor`.
 * @module @williamcodebox/omd-tool-str-replace-editor/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-tool-str-replace-editor'
