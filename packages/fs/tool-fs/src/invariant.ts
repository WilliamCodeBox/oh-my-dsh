/**
 * Package-owned invariant companion for `@williamcodebox/omd-tool-fs`.
 * @module @williamcodebox/omd-tool-fs/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-tool-fs'
