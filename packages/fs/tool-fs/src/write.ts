 ...
 * @module @williamcodebox/omd-tool-fs/src/write
 */

import type { Context } from '@williamcodebox/cordis'
import { defineTool } from '@williamcodebox/omd-tools'
import type { DiffCallView, DiffResultView, ToolResult } from '@williamcodebox/omd-tools'
import type { FsWriteOutcome } from '@williamcodebox/omd-fs'
