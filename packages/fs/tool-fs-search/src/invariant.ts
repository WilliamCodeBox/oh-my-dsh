/**
 * Package-owned invariant companion for `@williamcodebox/omd-tool-fs-search`.
 * @module @williamcodebox/omd-tool-fs-search/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-tool-fs-search'
