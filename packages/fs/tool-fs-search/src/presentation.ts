 ...
 * model-facing render consumes ({@link module:@williamcodebox/omd-tool-fs-search/search-core}
 ...
 *
 * @module @williamcodebox/omd-tool-fs-search/presentation
 */
 ...
 * ({@link module:@williamcodebox/omd-tool-fs-search/grep} `formatGrepMatches`), so
