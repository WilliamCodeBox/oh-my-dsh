 ...
 *
 * @module @williamcodebox/omd-tool-fs-search/grep
 */

import type { Context } from '@williamcodebox/cordis'
import { defineTool } from '@williamcodebox/omd-tools'
import type { GenericCallView, SearchResultView, ToolResult } from '@williamcodebox/omd-tools'
import type { RetainedItems } from '@williamcodebox/omd-output-retention'
import type { SpillRef } from '@williamcodebox/omd-spill'
