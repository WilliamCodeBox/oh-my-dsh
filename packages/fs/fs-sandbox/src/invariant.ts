/**
 * Package-owned invariant companion for `@williamcodebox/omd-fs-sandbox`.
 * @module @williamcodebox/omd-fs-sandbox/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-fs-sandbox'
