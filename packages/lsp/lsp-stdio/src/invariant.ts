/**
 * Package-owned invariant companion for `@williamcodebox/omd-lsp-stdio`.
 * @module @williamcodebox/omd-lsp-stdio/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-lsp-stdio'
