...
import Lsp, { type LspProvider, type LspQueryRequest, type LspQueryResult } from '@williamcodebox/omd-lsp'
import { deadline } from '@williamcodebox/omd-timeout'
...
import * as LspLocal from '@williamcodebox/omd-lsp-stdio'
import type { LspLocalServerConfig } from '@williamcodebox/omd-lsp-stdio'
