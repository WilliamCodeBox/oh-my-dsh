/**
 * Package-owned invariant companion for `@williamcodebox/omd-mcp-client`.
 * @module @williamcodebox/omd-mcp-client/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-mcp-client'
