/**
 * Package-owned invariant companion for `@williamcodebox/omd-tool-skill`.
 * @module @williamcodebox/omd-tool-skill/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-tool-skill'
