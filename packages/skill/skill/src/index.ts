 ...
 * Concrete
 * providers such as `@williamcodebox/omd-skill-filesystem` decide where skills come
 ...
 *
 * @module @williamcodebox/omd-skill
 */

import { Context, Service } from '@williamcodebox/cordis'
import { assertNever } from '@williamcodebox/omd-llm'
import { NamedEntries, ScopedLayers, scopeChainOf, scopeOf } from '@williamcodebox/omd-scope'
import type { ScopeKey, ScopeLayer } from '@williamcodebox/omd-scope'
import z from '@williamcodebox/schemastery'
import type Schema from '@williamcodebox/schemastery'
