/**
 * Package-owned invariant companion for `@williamcodebox/omd-acp-demo`.
 * @module @williamcodebox/omd-acp-demo/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-acp-demo'
