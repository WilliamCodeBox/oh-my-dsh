 ...
 * ({@link @williamcodebox/omd-agent-spine-demo}), JSONL session persistence, and
 * the {@link @williamcodebox/omd-acp} bridge. The app owns those plugins through one
 ...
 * @module @williamcodebox/omd-acp-demo
 */

import type { Context } from '@williamcodebox/cordis'
import { join } from 'node:path'
import z from '@williamcodebox/schemastery'
import * as acp from '@williamcodebox/omd-acp'
import * as agentCore from '@williamcodebox/omd-agent-spine-demo'
...
} from '@williamcodebox/omd-session-persistence-jsonl'
import * as sessionCheckpointPolicy from '@williamcodebox/omd-session-checkpoint-policy'
