/**
 * Package-owned invariant companion for `@williamcodebox/omd-sdk-jsonrpc-demo`.
 * @module @williamcodebox/omd-sdk-jsonrpc-demo/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-sdk-jsonrpc-demo'
