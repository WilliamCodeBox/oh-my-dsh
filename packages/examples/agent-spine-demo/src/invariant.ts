/**
 * Package-owned invariant companion for `@williamcodebox/omd-agent-spine-demo`.
 * @module @williamcodebox/omd-agent-spine-demo/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-agent-spine-demo'
