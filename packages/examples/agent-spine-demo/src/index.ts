 ...
 * @module @williamcodebox/omd-agent-spine-demo
 */

import type { Context } from '@williamcodebox/cordis'
import Timer from '@williamcodebox/cordis-plugin-timer'
...
import SessionTitleService, { type Config as SessionTitleConfig } from '@williamcodebox/omd-session-title'
import SystemPrompt, { type Config as SystemPromptConfig } from '@williamcodebox/omd-system-prompt'
import ToolRuntime, { type Config as ToolsConfig } from '@williamcodebox/omd-tools'
import SkillRegistry, { type Config as SkillRegistryConfig } from '@williamcodebox/omd-skill'
import * as SkillFileSystem from '@williamcodebox/omd-skill-filesystem'
import AgentRegistry from '@williamcodebox/omd-agent'
import GoalService, { type Config as GoalDomainConfig } from '@williamcodebox/omd-goal'
import * as goalSession from '@williamcodebox/omd-goal-round-driver'
import * as toolGoal from '@williamcodebox/omd-tool-goal'
import LocalJobRegistry, { type Config as JobsConfig } from '@williamcodebox/omd-jobs-local'
import InvariantRegistry, { type Config as InvariantConfig } from '@williamcodebox/omd-invariants'
...
import * as scopeInvariant from '@williamcodebox/omd-scope/invariant'
...
import * as bashEnv from '@williamcodebox/omd-shell-env'
import * as workspaceContext from '@williamcodebox/omd-agent-instructions'
import * as toolSkill from '@williamcodebox/omd-tool-skill'
import * as toolJobs from '@williamcodebox/omd-tool-jobs'
import AgentLoop, { type Config as AgentLoopConfig } from '@williamcodebox/omd-agent-loop'
import * as llmRetry from '@williamcodebox/omd-llm-retry'
import { resolveDshHome } from '@williamcodebox/omd-home-paths'
