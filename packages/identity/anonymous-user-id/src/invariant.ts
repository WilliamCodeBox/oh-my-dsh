/**
 * Package-owned invariant companion for `@williamcodebox/omd-anonymous-user-id`.
 * @module @williamcodebox/omd-anonymous-user-id/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-anonymous-user-id'
