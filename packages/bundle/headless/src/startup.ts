 ...
 * @module @williamcodebox/omd-headless/startup
 */
...
export function apply(ctx: Context): void {
  ...
  program.action(() => {
    ...
    if (task.trim() === '') program.error('error: a task is required, for example: omd --profile headless "run the tests"')
