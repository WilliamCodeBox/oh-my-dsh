/**
 * Package-owned invariant companion for `@williamcodebox/omd-headless`.
 * @module @williamcodebox/omd-headless/invariant
 */

import type { Context } from '@williamcodebox/cordis'
import type { InvariantInstaller } from '@williamcodebox/omd-invariants'

const PACKAGE_NAME = '@williamcodebox/omd-headless'
