/**
 * Package-owned invariant companion for `@williamcodebox/omd-credentials`.
 * @module @williamcodebox/omd-credentials/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-credentials'
