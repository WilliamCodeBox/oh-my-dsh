 ...
 * @module @williamcodebox/omd-credentials-local
 */
...
import { withFileLock, writeFileAtomic } from '@williamcodebox/omd-atomic-write'
import { canonicalizeWatchPath, resolveDshHome } from '@williamcodebox/omd-home-paths'
import { launchEnvironmentOf } from '@williamcodebox/omd-launch-environment'
import { CredentialProvider, credentialRef } from '@williamcodebox/omd-credentials'
import type { CredentialInfo, CredentialRef, ResolvedCredential } from '@williamcodebox/omd-credentials'
import type { LaunchEnvironmentEntry } from '@williamcodebox/omd-launch-environment'
