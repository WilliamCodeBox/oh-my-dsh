/**
 * Package-owned invariant companion for `@williamcodebox/omd-llm-replay`.
 * @module @williamcodebox/omd-llm-replay/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-llm-replay'
