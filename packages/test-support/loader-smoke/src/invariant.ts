/**
 * Package-owned invariant companion for `@williamcodebox/omd-loader-smoke`.
 * @module @williamcodebox/omd-loader-smoke/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-loader-smoke'
