/**
 * Package-owned invariant companion for `@williamcodebox/omd-llm-mock-server`.
 * @module @williamcodebox/omd-llm-mock-server/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-llm-mock-server'
