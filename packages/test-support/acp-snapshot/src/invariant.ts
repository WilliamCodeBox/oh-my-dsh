/**
 * Package-owned invariant companion for `@williamcodebox/omd-acp-snapshot`.
 * @module @williamcodebox/omd-acp-snapshot/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-acp-snapshot'
