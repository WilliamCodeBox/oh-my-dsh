/** Package-owned hook invocation/result stream invariants. @module @williamcodebox/omd-hook-protocol/invariant */
...
const PACKAGE_NAME = '@williamcodebox/omd-hook-protocol'
