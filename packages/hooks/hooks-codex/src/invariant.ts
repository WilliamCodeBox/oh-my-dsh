/**
 * Package-owned invariant companion for `@williamcodebox/omd-hooks-codex`.
 * @module @williamcodebox/omd-hooks-codex/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-hooks-codex'
