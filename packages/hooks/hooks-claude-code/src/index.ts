 ...
 * @module @williamcodebox/omd-hooks-claude-code
 */
...
import type { PostToolDecision, PreToolDecision, ToolExecution, ToolExecutionResult } from '@williamcodebox/omd-tools'
import {
  appendHookInvoked,
  appendHookResult,
  createDetachedRuns,
...
} from '@williamcodebox/omd-hook-protocol'
// Pulls in the declaration-merged subagent events and the identity pairing their
// start/end edges.
import type { SubagentRunId } from '@williamcodebox/omd-subagent'
