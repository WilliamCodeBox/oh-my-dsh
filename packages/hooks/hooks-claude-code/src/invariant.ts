/**
 * Package-owned invariant companion for `@williamcodebox/omd-hooks-claude-code`.
 * @module @williamcodebox/omd-hooks-claude-code/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-hooks-claude-code'
