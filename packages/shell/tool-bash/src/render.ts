 ...
 *
 * @module @williamcodebox/omd-tool-bash/render
 */

import type { ShellProcessRead, ShellRunResult, ShellSandboxInfo, CollectedOutput } from '@williamcodebox/omd-shell'
import type { SandboxMode } from '@williamcodebox/omd-sandbox'
import { escalationHintMarker, sandboxDenialMarker } from '@williamcodebox/omd-sandbox'
 ...
 * rendering story, owned by `@williamcodebox/omd-shell` so `dsh-tool-pwsh` reuses
 ...
 */
export { parseExitStatus, type ParsedExitStatus } from '@williamcodebox/omd-shell'
