/**
 * Package-owned invariant companion for `@williamcodebox/omd-tool-bash`.
 * @module @williamcodebox/omd-tool-bash/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-tool-bash'
