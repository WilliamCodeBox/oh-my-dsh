/**
 * Real-process tests for `@williamcodebox/omd-pwsh-local`: the LOCAL subprocess
...
import { PwshLocalExecutor, ENCODING_PREAMBLE, candidatePwshPaths, resolvePwshPath } from '@williamcodebox/omd-pwsh-local'
...
import type { SubprocessHandle, SubprocessOutputReader, SubprocessSpawnSpec } from '@williamcodebox/omd-subprocess'
import { MAX_TIMER_DELAY_MS } from '@williamcodebox/omd-timeout'
import type { ShellProcess } from '@williamcodebox/omd-shell'
