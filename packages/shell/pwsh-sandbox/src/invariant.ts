/**
 * Package-owned invariant companion for `@williamcodebox/omd-pwsh-sandbox`.
 * @module @williamcodebox/omd-pwsh-sandbox/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-pwsh-sandbox'
