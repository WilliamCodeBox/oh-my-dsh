 ...
 * `@williamcodebox/omd-bash-sandbox`. It wraps the exact local pwsh argv through
 ...
 * renders.
 * @module @williamcodebox/omd-pwsh-sandbox
 */
...
import { SandboxUnavailableError } from '@williamcodebox/omd-sandbox'
import type {
  ConfinedArgv,
  ConfinedSandboxMode,
  RunnerFailureRule,
