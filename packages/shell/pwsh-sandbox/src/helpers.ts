 ...
 * mirror of `@williamcodebox/omd-bash-sandbox/src/helpers.ts` (the pwsh twin of
 * the bash consumer shares the identical classification dialect).
 *
 * @module @williamcodebox/omd-pwsh-sandbox/helpers
 */

/* jscpd:ignore-start */
import { accessSync, constants, statSync } from 'node:fs'
import type { ShellRunResult } from '@williamcodebox/omd-shell'
import type { RunnerFailureRule } from '@williamcodebox/omd-sandbox'
