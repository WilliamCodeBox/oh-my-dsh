/**
 * Package-owned invariant companion for `@williamcodebox/omd-tool-bash-persistent`.
 * @module @williamcodebox/omd-tool-bash-persistent/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-tool-bash-persistent'
