 ...
 * @module @williamcodebox/omd-message-feedback
 */

import { Buffer } from 'node:buffer'
import { randomUUID } from 'node:crypto'
import { Context, Service } from '@williamcodebox/cordis'
import s from '@williamcodebox/schemastery'
import { deriveEventMessage, isAppendSurfaceEvent } from '@williamcodebox/omd-session/surface'
import type { SessionHeader, SessionId } from '@williamcodebox/omd-session/types'
import type { SessionInspection } from '@williamcodebox/omd-session-persistence'
import type { KvTable } from '@williamcodebox/omd-storage-domain'
import { TypertRemoteService, Remote } from '@williamcodebox/omd-typert-protocol'
