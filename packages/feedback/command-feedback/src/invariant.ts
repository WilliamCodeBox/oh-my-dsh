/**
 * Package-owned invariant companion for `@williamcodebox/omd-command-feedback`.
 * @module @williamcodebox/omd-command-feedback/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-command-feedback'
