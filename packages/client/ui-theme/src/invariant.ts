/**
 * Package-owned invariant companion for `@williamcodebox/omd-client-ui-theme`.
 * @module @williamcodebox/omd-client-ui-theme/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-client-ui-theme'
