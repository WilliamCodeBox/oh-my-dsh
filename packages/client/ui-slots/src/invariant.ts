/**
 * Package-owned invariant companion for `@williamcodebox/omd-client-ui-slots`.
 * @module @williamcodebox/omd-client-ui-slots/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-client-ui-slots'
