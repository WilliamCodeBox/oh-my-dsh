...
import type { GoalSnapshot } from '@williamcodebox/omd-goal/client'
import {
...
import type { PropsLocale } from '@williamcodebox/omd-client-ui-slots'
...
export type GoalDockProps = import('@williamcodebox/omd-client-ui-slots').PropsRuntime<'conversation.input.dock'> & GoalBarActions & PropsLocale<'goal'>
