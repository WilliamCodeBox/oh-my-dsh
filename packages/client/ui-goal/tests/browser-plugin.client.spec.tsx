...
import { ConversationEventRegistry } from '@williamcodebox/omd-client-runtime/src/client/conversation/event-registry.ts'
import type { GoalProjection } from '@williamcodebox/omd-goal/client'
