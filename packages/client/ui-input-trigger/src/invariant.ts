/**
 * Package-owned invariant companion for `@williamcodebox/omd-client-ui-input-trigger`.
 * @module @williamcodebox/omd-client-ui-input-trigger/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-client-ui-input-trigger'
