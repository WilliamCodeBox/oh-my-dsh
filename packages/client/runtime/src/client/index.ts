...
import type { ConnectionHandle, SessionId } from '@williamcodebox/omd-api-remotes/client'
...
import type { TypertContext } from '@williamcodebox/omd-typert-protocol'
import type { MaybeSnapshotSelectorHook, SnapshotSelectorHook } from '@williamcodebox/omd-client-ui-slots'
...
export { isAppendSurfaceEvent, isReplacementSurfaceEvent } from '@williamcodebox/omd-session/surface'
...
export type { SubagentAddress, JobView } from '@williamcodebox/omd-client-connection/client'
...
export type { SessionId } from '@williamcodebox/omd-client-connection/client'
...
declare module '@williamcodebox/omd-client-ui-slots' {
  /**
