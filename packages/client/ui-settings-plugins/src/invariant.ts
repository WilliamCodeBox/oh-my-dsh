/**
 * Package-owned invariant companion for `@williamcodebox/omd-client-ui-settings-plugins`.
 * @module @williamcodebox/omd-client-ui-settings-plugins/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-client-ui-settings-plugins'
