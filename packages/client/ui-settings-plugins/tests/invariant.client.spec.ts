...
import * as PluginConfigInvariant from '@williamcodebox/omd-client-ui-settings-plugins/invariant'
...
describe('invariant companion', () => {
  ...
  it('has an empty node half', async () => {
    const { apply } = await import('@williamcodebox/omd-client-ui-settings-plugins')
