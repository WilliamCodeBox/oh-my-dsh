/**
 * Package-owned invariant companion for `@williamcodebox/omd-client-ui-plan`.
 * @module @williamcodebox/omd-client-ui-plan/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-client-ui-plan'
