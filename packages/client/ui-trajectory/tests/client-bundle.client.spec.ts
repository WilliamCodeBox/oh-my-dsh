 ...
 * not built (`pnpm --filter @williamcodebox/omd-client-ui-trajectory bundle`).
 */
...
const PLUGIN_ID = '@williamcodebox/omd-client-ui-trajectory'
...
describe('tsdown client artifact', () => {
  ...
  async function loadArtifact() {
    ...
    const modules = new Map<string, unknown>([
      ...
      ['@williamcodebox/omd-client-runtime/client', await import('@williamcodebox/omd-client-runtime/client')],
      ['@williamcodebox/omd-client-ui-primitives', await import('@williamcodebox/omd-client-ui-primitives')],
    ])
  ...
  it.skipIf(code === undefined)('mounted as an object plugin, apply registers the view tab on the real ring', async () => {
    ...
    const locale = await import('@williamcodebox/omd-client-locale/client')
