/**
 * Package-owned invariant companion for `@williamcodebox/omd-client-ui-trajectory`.
 * @module @williamcodebox/omd-client-ui-trajectory/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-client-ui-trajectory'
