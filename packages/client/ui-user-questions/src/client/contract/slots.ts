 ...
 * that consumes it.
 */
import type { PropsLocale, PropsRuntime } from '@williamcodebox/omd-client-ui-slots'
...
import type { PendingWait } from '@williamcodebox/omd-client-runtime/client'
import type { QuestionResponsePayload } from '@williamcodebox/omd-api-remotes/client'
