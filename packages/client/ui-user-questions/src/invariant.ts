/**
 * Package-owned invariant companion for `@williamcodebox/omd-client-ui-user-questions`.
 * @module @williamcodebox/omd-client-ui-user-questions/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-client-ui-user-questions'
