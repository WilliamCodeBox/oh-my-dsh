/**
 * Package-owned invariant companion for `@williamcodebox/omd-client-ui-primitives`.
 * @module @williamcodebox/omd-client-ui-primitives/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-client-ui-primitives'
