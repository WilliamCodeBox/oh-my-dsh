...
const SNAPSHOT = {
  entries: [
    { entryId: '8a1b2c3d', moduleName: '@williamcodebox/cordis-plugin-hmr', enabled: true, fiberPhase: 'active' },
    ...
    { entryId: 'disabled-entry', moduleName: '@williamcodebox/omd-host-directory-picker-native', enabled: false, fiberPhase: null },
  ],
