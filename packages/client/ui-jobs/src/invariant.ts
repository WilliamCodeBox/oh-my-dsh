/**
 * Package-owned invariant companion for `@williamcodebox/omd-client-ui-jobs`.
 * @module @williamcodebox/omd-client-ui-jobs/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-client-ui-jobs'
