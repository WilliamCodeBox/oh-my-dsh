 ...
 */
import type { ConnectionHandle } from '@williamcodebox/omd-api-remotes/client'
// Type-only: pulls the locale plugin's Context merge (ctx.locale).
import type {} from '@williamcodebox/omd-client-locale/client'
// Type-only: the settings slot types (this package registers a General row).
import type {} from '@williamcodebox/omd-client-ui-settings/client'
// Type-only: pulls the ctx.remote merge and the forwarded-event key face
// (the settings invalidation rides the allowlist) into this program.
import type {} from '@williamcodebox/omd-api-remotes/client'
import type { ClientContext, SessionFace } from '@williamcodebox/omd-client-runtime/client'
import type { CommandUiContract, SelectOption } from '@williamcodebox/omd-client-ui-commands/client'
import type { ClientSessionContext } from '@williamcodebox/omd-client-ui-input-trigger/client'
import type { PermissionSelect } from '@williamcodebox/omd-permission-presets/client'
