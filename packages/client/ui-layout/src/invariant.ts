/**
 * Package-owned invariant companion for `@williamcodebox/omd-client-ui-layout`.
 * @module @williamcodebox/omd-client-ui-layout/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-client-ui-layout'
