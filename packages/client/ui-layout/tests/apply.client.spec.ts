...
import { apply as themeApply, inject as themeInject, ThemeRuntime } from '@williamcodebox/omd-client-ui-theme/client'
import { apply, inject, LayoutController } from '@williamcodebox/omd-client-ui-layout/client'
import { apply as nodeApply } from '@williamcodebox/omd-client-ui-layout'
import * as invariant from '@williamcodebox/omd-client-ui-layout/invariant'
...
describe('node half + invariant companion', () => {
  ...
  it('invariant companion registers under the package name', async () => {
    ...
    expect(register).toHaveBeenCalledWith('@williamcodebox/omd-client-ui-layout', expect.any(Function))
