/**
 * Package-owned invariant companion for `@williamcodebox/omd-client-connection`.
 * @module @williamcodebox/omd-client-connection/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-client-connection'
