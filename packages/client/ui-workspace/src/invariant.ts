/**
 * Package-owned invariant companion for `@williamcodebox/omd-client-ui-workspace`.
 * @module @williamcodebox/omd-client-ui-workspace/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-client-ui-workspace'
