/**
 * Package-owned invariant companion for `@williamcodebox/omd-client-ui-skill`.
 * @module @williamcodebox/omd-client-ui-skill/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-client-ui-skill'
