/**
 * Package-owned invariant companion for `@williamcodebox/omd-client-ui-deliverables`.
 * @module @williamcodebox/omd-client-ui-deliverables/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-client-ui-deliverables'
