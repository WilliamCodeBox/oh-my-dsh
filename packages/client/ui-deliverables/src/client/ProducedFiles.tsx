...
import type { HostDescriptionSource } from '@williamcodebox/omd-client-connection/client'
import type { InjectFace, PropsLocale } from '@williamcodebox/omd-client-ui-slots'
