...
import { isAppendSurfaceEvent } from '@williamcodebox/omd-client-runtime/client'
import type { MarkdownFileMentions } from '@williamcodebox/omd-client-ui-primitives'
import type { TurnTailOwnerProps } from '@williamcodebox/omd-client-ui-conversation/client'
...
declare module '@williamcodebox/omd-client-runtime/client' {
