...
import type { ChatFileMentions, TurnTailOwnerProps } from '@williamcodebox/omd-client-ui-conversation/client'
import { makeTranslate, stubSettingsScope } from '@williamcodebox/omd-client-test-runtime'
import {
...
describe('package shells', () => {
  it('the invariant companion registers ownership', async () => {
    ...
    expect(registered).toEqual(['@williamcodebox/omd-client-ui-deliverables'])
