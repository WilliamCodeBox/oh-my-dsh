/**
 * Package-owned invariant companion for `@williamcodebox/omd-client-ui-settings-general`.
 * @module @williamcodebox/omd-client-ui-settings-general/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-client-ui-settings-general'
