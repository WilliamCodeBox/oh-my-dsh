...
import * as AgentPresetInvariant from '@williamcodebox/omd-client-ui-agent-preset/invariant'
...
describe('invariant companion', () => {
  ...
  it('has an empty node half', async () => {
    const { apply } = await import('@williamcodebox/omd-client-ui-agent-preset')
