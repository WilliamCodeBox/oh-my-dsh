/**
 * Package-owned invariant companion for `@williamcodebox/omd-client-ui-agent-preset`.
 * @module @williamcodebox/omd-client-ui-agent-preset/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-client-ui-agent-preset'
