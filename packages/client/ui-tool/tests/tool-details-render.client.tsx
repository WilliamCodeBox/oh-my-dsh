...
import type { SessionProviderComponent, TranslateNS } from '@williamcodebox/omd-client-ui-slots'
import type { DetailsSlotProps, DetailsToolOwnerProps } from '@williamcodebox/omd-client-ui-conversation/src/client/contract/slots.ts'
