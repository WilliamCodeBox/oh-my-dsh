...
import type { ToolResultView } from '@williamcodebox/omd-api-remotes/client'
import { bindSnapshotSelector } from '@williamcodebox/omd-client-web-react'
import type { SelectionTarget } from '@williamcodebox/omd-client-ui-conversation/client'
import type { ToolCallOwnerProps } from '@williamcodebox/omd-client-ui-tool/client'
import { IconGlobeOutline14 } from '@williamcodebox/omd-client-ui-primitives'
import { webCardModel } from '../src/client/tool/models/web-card-model.ts'
import { createChatStore } from '@williamcodebox/omd-client-ui-conversation/src/client/stores.ts'
import { GenericToolCard } from '../src/client/tool/toolviews/GenericToolCard.tsx'
import { DetailsPanel } from '@williamcodebox/omd-client-ui-conversation/src/client/skeleton/DetailsPanel.tsx'
import { WebRow, webToolview } from '../src/client/tool/toolviews/web-row.tsx'
import { renderToolDetails, SessionProviderStub, toolChatSnapshot } from './tool-details-render.client.tsx'
import { makeTranslate } from '@williamcodebox/omd-client-test-runtime'
import { zh as commonZh } from '@williamcodebox/omd-client-locale/src/locales/zh.ts'
import { zh } from '@williamcodebox/omd-client-ui-conversation/src/client/locales.ts'
...
describe('web toolview registration', () => {
  it('registers one WebRow under both web_search and web_fetch', () => {
    ...
    } as unknown as import('@williamcodebox/cordis').Context
