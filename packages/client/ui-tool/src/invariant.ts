/**
 * Package-owned invariant companion for `@williamcodebox/omd-client-ui-tool`.
 * @module @williamcodebox/omd-client-ui-tool/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-client-ui-tool'
