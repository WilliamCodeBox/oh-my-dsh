...
import type { PropsLocale, PropsRenderSlots, PropsRuntime } from '@williamcodebox/omd-client-ui-slots'
import type { ToolCallBlock } from '@williamcodebox/omd-client-runtime/client'
