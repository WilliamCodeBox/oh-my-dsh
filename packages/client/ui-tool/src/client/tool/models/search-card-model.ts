 ...
 * ({@link module:@williamcodebox/omd-tools/src/presentation}). This derivation
 ...
 * @module
 */
import type { SearchBlockProps, SearchFileGroup } from '@williamcodebox/omd-client-ui-primitives'
