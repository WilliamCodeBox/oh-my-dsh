...
import * as ModulesClient from '@williamcodebox/omd-client-modules/client'
import {
  ClientModuleSystem, parseBootManifest,
  type BootManifest, type ClientModuleSystemOptions, type DshWindow,
} from '@williamcodebox/omd-client-modules/client'
 ...
 * twice.
 */
const MODULES_ID = '@williamcodebox/omd-client-modules'
