/**
 * Package-owned invariant companion for `@williamcodebox/omd-client-web`.
 * @module @williamcodebox/omd-client-web/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-client-web'
