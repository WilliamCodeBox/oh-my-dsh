...
import * as ModelsInvariant from '@williamcodebox/omd-client-ui-settings-models/invariant'
...
describe('invariant companion', () => {
  ...
  it('node-half apply is a no-op host placeholder', async () => {
    const { apply } = await import('@williamcodebox/omd-client-ui-settings-models')
    apply()
