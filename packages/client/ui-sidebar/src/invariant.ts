/**
 * Package-owned invariant companion for `@williamcodebox/omd-client-ui-sidebar`.
 * @module @williamcodebox/omd-client-ui-sidebar/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-client-ui-sidebar'
