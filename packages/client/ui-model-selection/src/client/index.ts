...
import type { ModelSelection, SessionModels } from '@williamcodebox/omd-api-remotes/client'
import type { ClientContext } from '@williamcodebox/omd-client-runtime/client'
import type { CommandUiContract, SelectOption } from '@williamcodebox/omd-client-ui-commands/client'
// Type-only: pulls the ui-conversation SlotMap merge (the input.model seat).
import type {} from '@williamcodebox/omd-client-ui-conversation/client'
// Type-only: pulls the locale plugin's Context merge (ctx.locale).
import type {} from '@williamcodebox/omd-client-locale/client'
import type { TranslateNS } from '@williamcodebox/omd-client-ui-slots'
