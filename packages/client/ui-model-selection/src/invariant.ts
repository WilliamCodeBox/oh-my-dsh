/**
 * Package-owned invariant companion for `@williamcodebox/omd-client-ui-model-selection`.
 * @module @williamcodebox/omd-client-ui-model-selection/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-client-ui-model-selection'
