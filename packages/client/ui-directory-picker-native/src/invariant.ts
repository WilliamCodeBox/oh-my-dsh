/**
 * Package-owned invariant companion for `@williamcodebox/omd-client-ui-directory-picker-native`.
 * @module @williamcodebox/omd-client-ui-directory-picker-native/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-client-ui-directory-picker-native'
