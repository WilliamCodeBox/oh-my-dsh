/**
 * Package-owned invariant companion for `@williamcodebox/omd-client-modules`.
 * @module @williamcodebox/omd-client-modules/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-client-modules'
