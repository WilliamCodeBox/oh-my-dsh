/**
 * Package-owned invariant companion for `@williamcodebox/omd-client-ui-conversation`.
 * @module @williamcodebox/omd-client-ui-conversation/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-client-ui-conversation'
