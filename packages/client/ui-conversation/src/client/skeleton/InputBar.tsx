...
} from '@williamcodebox/omd-client-ui-primitives'
import { AttachmentRail, DropOverlay, ImageLightbox } from '@williamcodebox/omd-client-ui-attachment'
import type { AttachmentRailItem } from '@williamcodebox/omd-client-ui-attachment'
// Type-only: the `plan` projection key merge (the TodoDock posture — the
// composer reads a host-computed value; the domain owns the key).
import type {} from '@williamcodebox/omd-plan-mode/client'
// Type-only: the `goal` projection key merge (hint disambiguation).
import type {} from '@williamcodebox/omd-goal/client'
...
import type { Translate } from '@williamcodebox/omd-client-ui-slots'
