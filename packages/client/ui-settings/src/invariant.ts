/**
 * Package-owned invariant companion for `@williamcodebox/omd-client-ui-settings`.
 * @module @williamcodebox/omd-client-ui-settings/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-client-ui-settings'
