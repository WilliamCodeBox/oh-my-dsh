/**
 * Package-owned invariant companion for `@williamcodebox/omd-client-ui-attachment`.
 * @module @williamcodebox/omd-client-ui-attachment/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-client-ui-attachment'
