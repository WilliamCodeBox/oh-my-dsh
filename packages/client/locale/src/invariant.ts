/**
 * Package-owned invariant companion for `@williamcodebox/omd-client-locale`.
 * @module @williamcodebox/omd-client-locale/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-client-locale'
