...
import { apply as nodeApply } from '@williamcodebox/omd-client-locale'
import { apply as clientApply, COMMON_NS, LocaleRuntime, inject } from '@williamcodebox/omd-client-locale/client'
import * as LocaleInvariant from '@williamcodebox/omd-client-locale/invariant'
