/**
 * Package-owned invariant companion for `@williamcodebox/omd-client-ui-message-feedback`.
 * @module @williamcodebox/omd-client-ui-message-feedback/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-client-ui-message-feedback'
