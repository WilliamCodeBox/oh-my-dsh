 ...
 * @module @williamcodebox/omd-client-ui-message-feedback/client/controller
 */

import type { RemoteResult } from '@williamcodebox/omd-typert-protocol'
import type { HostObservable } from '@williamcodebox/omd-client-ui-slots'
import type { MessageId, SessionId } from '@williamcodebox/omd-client-connection/client'
import type {
...
} from '@williamcodebox/omd-message-feedback/types'
