/**
 * Package-owned invariant companion for `@williamcodebox/omd-client-web-react`.
 * @module @williamcodebox/omd-client-web-react/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-client-web-react'
