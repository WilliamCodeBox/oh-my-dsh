/**
 * Package-owned invariant companion for `@williamcodebox/omd-client-ui-commands`.
 * @module @williamcodebox/omd-client-ui-commands/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-client-ui-commands'
