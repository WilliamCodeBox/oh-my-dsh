/**
 * Package-owned invariant companion for `@williamcodebox/omd-typert-generator`.
 * @module @williamcodebox/omd-typert-generator/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-typert-generator'
