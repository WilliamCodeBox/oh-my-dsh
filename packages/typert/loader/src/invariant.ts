/**
 * Package-owned invariant companion for `@williamcodebox/omd-typert-loader`.
 * @module @williamcodebox/omd-typert-loader/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-typert-loader'
