/**
 * Package-owned invariant companion for `@williamcodebox/omd-typert-registry`.
 * @module @williamcodebox/omd-typert-registry/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-typert-registry'
