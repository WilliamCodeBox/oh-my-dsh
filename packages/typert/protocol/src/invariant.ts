/**
 * Package-owned invariant companion for `@williamcodebox/omd-typert-protocol`.
 * @module @williamcodebox/omd-typert-protocol/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-typert-protocol'
