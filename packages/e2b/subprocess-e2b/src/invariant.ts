/**
 * Package-owned invariant companion for `@williamcodebox/omd-subprocess-e2b`.
 * @module @williamcodebox/omd-subprocess-e2b/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-subprocess-e2b'
