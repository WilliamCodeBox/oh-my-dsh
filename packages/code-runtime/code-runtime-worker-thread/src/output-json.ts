/** JSON string-prefix accounting for the outer-output ledger. @module @williamcodebox/omd-code-runtime-worker-thread/output-json */

import type { CodeJsonValue } from '@williamcodebox/omd-code-runtime'
