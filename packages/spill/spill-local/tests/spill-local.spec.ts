...
import type { SaveTextSpill } from '@williamcodebox/omd-spill'
import LocalSpillStore, { encodeSegment, privateRoot, saveTextFile, sessionDir } from '@williamcodebox/omd-spill-local'
