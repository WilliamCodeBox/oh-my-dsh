/**
 * Package-owned invariant companion for `@williamcodebox/omd-terminal-bash`.
 * @module @williamcodebox/omd-terminal-bash/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-terminal-bash'
