/**
 * Package-owned invariant companion for `@williamcodebox/omd-terminal`.
 * @module @williamcodebox/omd-terminal/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-terminal'
