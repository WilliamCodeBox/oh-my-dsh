 ...
 * @module @williamcodebox/omd-tool-terminal
 */
...
import { TerminalSessionId } from '@williamcodebox/omd-terminal'
import type { TerminalSendResult, TerminalSessionId as TerminalSessionIdType, TerminalSignal } from '@williamcodebox/omd-terminal'
  ...
  ctx.tools.register(defineTool({
    ...
    async execute(args: SendArgs, exec) {
      ...
      if (args.run_in_background === true) {
        ...
        if (jobs === undefined) throw new Error('background terminal sends require @williamcodebox/omd-jobs and @williamcodebox/omd-tool-jobs')
