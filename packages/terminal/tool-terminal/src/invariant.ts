/**
 * Package-owned invariant companion for `@williamcodebox/omd-tool-terminal`.
 * @module @williamcodebox/omd-tool-terminal/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-tool-terminal'
