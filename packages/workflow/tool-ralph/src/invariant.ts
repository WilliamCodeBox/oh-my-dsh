/**
 * Package-owned invariant companion for `@williamcodebox/omd-tool-ralph`.
 * @module @williamcodebox/omd-tool-ralph/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-tool-ralph'
