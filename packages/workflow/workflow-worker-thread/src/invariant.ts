/**
 * Package-owned invariant companion for `@williamcodebox/omd-workflow-worker-thread`.
 * @module @williamcodebox/omd-workflow-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-workflow-worker-thread'
