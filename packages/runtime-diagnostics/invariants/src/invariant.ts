/**
 * Package-owned invariant companion for `@williamcodebox/omd-invariants`.
 * @module @williamcodebox/omd-invariants/invariant
 */
...
const PACKAGE_NAME = '@williamcodebox/omd-invariants'
