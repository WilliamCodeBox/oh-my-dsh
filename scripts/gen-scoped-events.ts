...
class ScopedEventGenerator {
  ...
  render(): string {
    ...
    return [
      ...
      ' *',
      ' * @module @williamcodebox/omd-scope/scoped-events.generated',
      ' */',
      '',
...
/** Return whether an Events interface is inside declare module '@williamcodebox/cordis'. */
function isCordisModuleInterface(node: ts.InterfaceDeclaration): boolean {
  ...
  return ts.isModuleBlock(block)
    ...
    && declaration.name.text === '@williamcodebox/cordis'
}
