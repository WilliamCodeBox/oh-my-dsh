...
import type { CordisCatalogModel, ServiceMethodEntry } from '@williamcodebox/omd-typert-generator'
...
function main(): void {
  ...
  const source = projector.renderRuntimeApi(clientModel(model))
    .replaceAll('@williamcodebox/omd-tool-cordis/api-catalog', '@williamcodebox/omd-cordis-client-runner/client/api-catalog')
