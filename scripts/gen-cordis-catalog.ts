...
import {
  ...
  REGION_BEGIN,
  REGION_END,
} from '@williamcodebox/omd-typert-generator'
import type { CordisCatalogPolicy } from '@williamcodebox/omd-typert-generator'
 ...
 * The scan that enforces this list reads EVERY `declare module '@williamcodebox/cordis'`
 ...
 * scan reads EVERY `declare module '@williamcodebox/cordis'` Events merge under
