...
import type { ToolSchema } from '@williamcodebox/omd-llm'
...
import LocalBashExecutor from '@williamcodebox/omd-bash-local'
import * as BashEnvPlugin from '@williamcodebox/omd-shell-env'
import { PwshLocalExecutor } from '@williamcodebox/omd-pwsh-local'
import LocalSubprocessRuntime from '@williamcodebox/omd-subprocess-local'
import LocalFileSystem from '@williamcodebox/omd-fs-local'
import { AttachmentStore } from '@williamcodebox/omd-attachment'
import type { ImageAttachmentLimits, ImageAttachmentRef, SaveImageAttachment, StoredImageAttachment } from '@williamcodebox/omd-attachment'
import UserQuestionService from '@williamcodebox/omd-user-questions'
import PlanModeController from '@williamcodebox/omd-plan-mode'
import WebRuntime from '@williamcodebox/omd-web'
import * as WebSearchExa from '@williamcodebox/omd-web-search-exa'
import * as WebFetchLocal from '@williamcodebox/omd-web-fetch-http'
import SubagentRuntime from '@williamcodebox/omd-subagent'
import type { SubagentProvider, SubagentReportDelivery } from '@williamcodebox/omd-subagent'
import * as ToolSubagentControl from '@williamcodebox/omd-tool-subagent-control'
import * as ToolSubagentListAgents from '@williamcodebox/omd-tool-subagent-control/list-agents'
import * as ToolSubagentReport from '@williamcodebox/omd-tool-subagent-report'
import SkillRegistry from '@williamcodebox/omd-skill'
import * as SkillFileSystem from '@williamcodebox/omd-skill-filesystem'
import LocalJobRegistry from '@williamcodebox/omd-jobs-local'
import * as ToolAskUser from '@williamcodebox/omd-tool-ask-user'
import * as ToolBash from '@williamcodebox/omd-tool-bash'
...
import CordisHostRunner from '@williamcodebox/omd-cordis-host-runner'
import * as ToolCordis from '@williamcodebox/omd-tool-cordis'
import * as ToolFs from '@williamcodebox/omd-tool-fs'
import * as ToolFsSearch from '@williamcodebox/omd-tool-fs-search'
import * as ToolStrReplaceEditor from '@williamcodebox/omd-tool-str-replace-editor'
import TerminalSessionService from '@williamcodebox/omd-terminal'
import * as ToolPty from '@williamcodebox/omd-tool-terminal'
import * as ToolGoal from '@williamcodebox/omd-tool-goal'
import * as ToolSchedule from '@williamcodebox/omd-schedule'
...
import * as ToolWeb from '@williamcodebox/omd-tool-web'
import VmWorkflowEngine from '@williamcodebox/omd-workflow-worker-thread'
import * as ToolRalph from '@williamcodebox/omd-tool-ralph'
import * as ToolWorkflow from '@williamcodebox/omd-tool-workflow'
...
const TOOL_PACKAGES: ToolPackage[] = [
  {
    pkg: '@williamcodebox/omd-tool-ask-user',
    dir: 'tool-ask-user',
  ...
  {
    pkg: '@williamcodebox/omd-plan-mode',
    dir: 'plan-mode',
  ...
  {
    pkg: '@williamcodebox/omd-tool-bash',
    dir: 'tool-bash',
  ...
  {
    pkg: '@williamcodebox/omd-tool-pwsh',
    dir: 'tool-pwsh',
  ...
  {
    pkg: '@williamcodebox/omd-tool-cordis',
    dir: 'tool-cordis',
  ...
  {
    pkg: '@williamcodebox/omd-tool-bash-persistent',
  ...
  {
    pkg: '@williamcodebox/omd-tool-str-replace-editor',
  ...
  {
    pkg: '@williamcodebox/omd-tool-fs',
    dir: 'tool-fs',
  ...
  {
    pkg: '@williamcodebox/omd-tool-fs-search',
    dir: 'tool-fs-search',
  ...
  {
    pkg: '@williamcodebox/omd-tool-terminal',
    dir: 'tool-terminal',
  ...
  {
    pkg: '@williamcodebox/omd-tool-goal',
    dir: 'tool-goal',
  ...
  {
    pkg: '@williamcodebox/omd-schedule',
    dir: 'schedule',
  ...
  {
    pkg: '@williamcodebox/omd-tool-lsp',
    dir: 'tool-lsp',
  ...
  {
    pkg: '@williamcodebox/omd-tool-ralph',
    dir: 'tool-ralph',
  ...
  {
    pkg: '@williamcodebox/omd-tool-skill',
    dir: 'tool-skill',
  ...
  {
    pkg: '@williamcodebox/omd-tool-subagent-control',
  ...
  {
    pkg: '@williamcodebox/omd-tool-subagent-report',
  ...
  {
    pkg: '@williamcodebox/omd-tool-jobs',
    dir: 'tool-jobs',
  ...
  {
    pkg: '@williamcodebox/omd-tool-todo',
    dir: 'tool-todo',
  ...
  {
    pkg: '@williamcodebox/omd-tool-workflow',
    dir: 'tool-workflow',
  ...
  {
    pkg: '@williamcodebox/omd-tool-web',
    dir: 'tool-web',
