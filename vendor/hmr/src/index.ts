import { Context, Service, type Plugin } from '@williamcodebox/cordis'
import type { Dict } from '@williamcodebox/cosmokit'
import { ModuleLoader, type ModuleJob, type ResolveResult } from '@williamcodebox/cordis-plugin-loader'
import type { Include } from '@williamcodebox/cordis-plugin-include'
import { FSWatcher, watch, type ChokidarOptions } from 'chokidar'
import { dirname, relative, resolve } from 'node:path'
import { realpath, stat } from 'node:fs/promises'
import { handleError } from './error.ts'
import type {} from '@williamcodebox/cordis-plugin-timer'
