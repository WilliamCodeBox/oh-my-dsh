import { EntryGroup, EntryTree, isJsExpr, type EntryOptions } from '@williamcodebox/cordis-plugin-loader'
 ...
 * (`omd --dump-config`) parses and prints exactly the dialect this include
 * mounts.
 */
 ...
 * (`omd --dump-config`) so a dump can never drift from what boots. The input
