...
- `packages/*` (except agent-loop's own tests and examples/) must not import `@williamcodebox/omd-agent-loop`.
- No cross-package deep imports (`@williamcodebox/omd-*/src/...` paths) — public entry points only.
