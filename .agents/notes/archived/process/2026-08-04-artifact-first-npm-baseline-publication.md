...
- Installed `@williamcodebox/oh-my-dsh` runs `omd --version` and `omd --dump-default-config` successfully under plain Node, covering the static CLI entry and one dynamic mode entry.
