...
| --- | --- | --- | --- |
| `@williamcodebox/omd-storage` | `packages/storage/storage/` | `ctx.storage` (the hub) | ✓ |
| `@williamcodebox/omd-storage-json` | `packages/storage/storage-json/` | registers backend `json` | ✓ |
| `@williamcodebox/omd-storage-sqlite` | `packages/storage/storage-sqlite/` | registers backend `sqlite` | ✓ |
| `@williamcodebox/omd-storage-domain` | `packages/storage/storage-domain/` | mounts `ctx.storage.domain` | ✓ |
| `@williamcodebox/omd-workspace` | `packages/workspace/workspace/` | `ctx.workspaceRegistry` | ✓ |
