...
- `DSH_HOME` is always the absolute configured Harness home. The standalone [`@williamcodebox/omd-home-paths`](../../../../packages/util/home-paths/README.md) utility owns its precedence: explicit `dshHome`, then ambient `$DSH_HOME`, then `~/.dsh`.
