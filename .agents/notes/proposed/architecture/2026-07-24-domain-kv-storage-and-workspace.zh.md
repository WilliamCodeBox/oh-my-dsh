...
| 包 | 路径 | ctx 面 | 本期 |
| --- | --- | --- | --- |
| `@williamcodebox/omd-storage` | `packages/storage/storage/` | `ctx.storage`（枢纽） | ✓ |
| `@williamcodebox/omd-storage-json` | `packages/storage/storage-json/` | 注册后端 `json` | ✓ |
| `@williamcodebox/omd-storage-sqlite` | `packages/storage/storage-sqlite/` | 注册后端 `sqlite` | ✓ |
| `@williamcodebox/omd-storage-domain` | `packages/storage/storage-domain/` | 挂载 `ctx.storage.domain` | ✓ |
