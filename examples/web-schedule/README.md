...
This overlay opts one `omd web` process into Schedule reminders without changing the shipped default Web composition:

```sh
omd web --patch examples/web-schedule/cordis.yml
```
