/**
 * `omd plugin --profile <name> <args...>` — profile plugin management as a
 ...
 * @module @williamcodebox/oh-my-dsh/plugin
 */
...
/**
 * Run one `omd plugin` invocation: init if needed, forward to pnpm, reconcile.
