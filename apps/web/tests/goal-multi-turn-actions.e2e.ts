...
import { parseSessionLog } from '@williamcodebox/omd-llm-replay'
import type { SessionEvent, SessionId } from '@williamcodebox/omd-session'
import type {} from '@williamcodebox/omd-goal'
import {
...
const PACKAGE_FILES: Readonly<Record<string, string>> = {
  ...
  'packages/client/ui-conversation/package.json': '{"name":"@williamcodebox/omd-client-ui-conversation"}\n',
  ...
  'packages/context/session-reference/package.json': '{"name":"@williamcodebox/omd-session-reference"}\n',
  ...
  'packages/llm/token-meter/package.json': '{"name":"@williamcodebox/omd-token-meter"}\n',
  ...
  'packages/skill/skill-filesystem/package.json': '{"name":"@williamcodebox/omd-skill-filesystem"}\n',
