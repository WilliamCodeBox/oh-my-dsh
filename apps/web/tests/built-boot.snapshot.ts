...
it('boots the built plugin graph and renders a fixture session end to end', async () => {
  ...
  for (const plugin of ['@williamcodebox/omd-client-ui-layout', '@williamcodebox/omd-client-ui-sidebar', '@williamcodebox/omd-client-ui-conversation', '@williamcodebox/omd-client-ui-tool']) {
