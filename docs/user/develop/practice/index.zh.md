...
import { MyCapService, type MyCapRequest, type MyCapResult } from '@williamcodebox/omd-my-cap'
...
```yaml
- name: '@williamcodebox/omd-my-cap-local'
- name: '@williamcodebox/omd-tool-my-cap'
```
